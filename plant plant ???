...
PREDICTED_LABELS = {'Tomato__Late_blight': 'Tomato - Late blight', 'Tomato__Septoria_leaf_spot':'Tomato - Septoria leaf spot', 'Tomato___Healthy':'Healthy tomato leaf!!'} #categories -> what's on screen in the app 

def get_prediction(image_data): #expects parameter image data
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/e4b4902b-c9c0-457c-b246-db30c94de0ff'  
